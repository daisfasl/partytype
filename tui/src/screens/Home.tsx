    ...
    >
      ...
      >
        ...
        <Menu direction="column">
          <MenuItem label="Practice Mode" onSelect={() => onNavigate("practice")} />
          <MenuItem label="Create a Party" onSelect={() => onNavigate("create-party")} />
          <MenuItem label="Join a Party" onSelect={() => onNavigate("join-party")} />
